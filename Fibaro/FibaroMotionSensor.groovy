 ...
 *	References:
 *
 *		https://community.smartthings.com/t/beta-fibaro-motion-sensor-new-device-handler-with-all-settings-and-auto-sync-feature/18779
 *
 */

metadata {
	definition (name: "My Fibaro Motion Sensor", namespace: "TheHundredthIdiot", author: "Andy") {
    ...
    tiles (scale: 2) {
 		multiAttributeTile(name:"illuminance", type:"lighting", width: 6, height: 4) {
			tileAttribute("device.illuminance", key: "PRIMARY_CONTROL") {
           		attributeState "default", label:'${currentValue} lux', unit:"lux", icon: "st.Weather.weather14",
            		backgroundColors: [
//	 
//	 			Khaki (#F0E68C):
//	 				http://www.w3schools.com/colors/colors_hex.asp  
//	 				http://www.w3schools.com/colors/colors_picker.asp?colorhex=F0E68C
//
						[value: 4098, color: "#fcfae8"],
   			    	 	[value: 2048, color: "#f9f5d2"],
   		    	 		[value: 1024, color: "#f6f0bb"],
  			      		[value: 512,  color: "#f3eba5"],
		    		  	[value: 256,  color: "#f0e68c"],
    		    		[value: 232,  color: "#ede278"], 
        				[value: 208,  color: "#eadd61"],
        				[value: 184,  color: "#e7d84b"],
        				[value: 160,  color: "#e5d334"],
 	 	      			[value: 136,  color: "#e2ce1d"],
    		    		[value: 112,  color: "#cbb91a"],
        				[value: 88,   color: "#b4a518"],
        				[value: 64,   color: "#9e9015"],
       					[value: 32,   color: "#877c12"],
        				[value: 16,   color: "#71670f"],
  	      				[value: 8,    color: "#5a520c"],
    	    			[value: 4,    color: "#443e09"],
   	    	 			[value: 2,    color: "#2d2906"],
    	    			[value: 1,    color: "#171503"],
        				[value: 0,    color: "#000000"]
            		]
            }
 	 		tileAttribute("temperature", key: "SECONDARY_CONTROL") {
		   		attributeState "temperature", label:'Temperture ${currentValue}°'          
     	    }
 		}
        ...
        valueTile("temperature", "device.temperature", inactiveLabel: false, width: 2, height: 2) {
            ...
            backgroundColors:
            [
//                	[value: -100, color: "#cce5ff"], /*  -73°c */
//                	[value: 32,   color: "#99cbff"], /*  0°c   */
//                	[value: 41,   color: "#007dff"], /*  5°c   */
//                	[value: 65,   color: "#44b621"], /*  18°c  */
//                	[value: 77,   color: "#ff794d"], /*  25°c  */
//         		    [value: 86,   color: "#cc3300"]  /*  30°c  */
        ...
        valueTile("illuminance2", "device.illuminance", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
            state "illuminance", label:'${currentValue} lux', unit:""
        }
		main(["illuminance", "motion", "temperature", "acceleration"])
        details(["illuminance", "motion", "temperature", "acceleration", "illuminance2", "battery", "configure"])
    }
}
